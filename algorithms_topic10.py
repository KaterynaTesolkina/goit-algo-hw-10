...
# Висновки
# Генеруємо випадкові точки в прямокутнику, що охоплює область під графіком функції.
# Обчислюємо частку точок, що потрапляють під криву функції, і таким чином 
# знаходимо площу методом Монте-Карло.
# Порівнюємо отриманий результат з результатом, обчисленим за допомогою scipy.integrate.quad.
# Очікуваний результат:
# Метод Монте-Карло: приблизно ≈ 2.6667
# Аналітичний результат: 2.6667
# Результат функції quad: 2.6667
# Результати повинні бути дуже близькими один до одного, що підтверджує точність 
# методу Монте-Карло при достатньо великій кількості випадкових точок.
